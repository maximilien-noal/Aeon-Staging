...
namespace Aeon.Test
{
    ...
    public class Loops
    {
        ...
        public void TestInitialize()
        {
            ...
            this.vm.RegisterVirtualDevice(new CallbackInt(0x99, () => this.count++));
            this.vm.RegisterVirtualDevice(new CallbackInt(0x9A, () =>
                {
                    this.count++;
                    if(this.count == 500)
            ...
            this.vm.RegisterVirtualDevice(new CallbackInt(0x9B, () =>
                {
                    this.count++;
                    if(this.count == 500)
                        this.vm.PhysicalMemory.SetUInt16(vm.Processor.SS, (ushort)(vm.Processor.SP + 4), (ushort)EFlags.Zero);
                }));
