...
namespace Aeon.Emulator.Instructions.Strings
{
    internal static class Scasb
    {
        ...
        [Alternate("ScanByte", OperandSize = 16 | 32, AddressSize = 32)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    internal static class Scasw
    {
        ...
        [Alternate("ScanWord", OperandSize = 16, AddressSize = 32)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        [Alternate("ScanWord", OperandSize = 32, AddressSize = 16)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        [Alternate("ScanWord", OperandSize = 32, AddressSize = 32)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
