...
public class GdbCommandHandler {
    ...
    public GdbCommandHandler(GdbIo gdbIo, EmulatorHost machine) {
        this._gdbIo = gdbIo;
        ...
        this._gdbCustomCommandsHandler = new GdbCustomCommandsHandler(gdbIo, machine, _gdbCommandBreakpointHandler.OnBreakPointReached);
    }
    ...
    public void RunCommand(string command) {
        ...
        try {
            ...
            System.Diagnostics.Debug.WriteLine($"Responded with {response}");
            if (response != null) {
