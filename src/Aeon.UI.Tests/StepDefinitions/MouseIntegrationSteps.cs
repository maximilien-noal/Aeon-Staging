...
public sealed class MouseIntegrationSteps
{
    ...
    {
        var actual = Window.FindControl<EmulatorDisplay>("emulatorDisplay")!.MouseInputMode.ToString();
    ...
    {
        var isChecked = Window.FindControl<ToggleButton>("mouseIntegrationButton")!.IsChecked;
